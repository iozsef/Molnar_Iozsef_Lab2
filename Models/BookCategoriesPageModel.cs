...
namespace Molnar_Iozsef_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Molnar_Iozsef_Lab2Context context,
                                               Book book)
        {
        ...
        public void UpdateBookCategories(Molnar_Iozsef_Lab2Context context,
